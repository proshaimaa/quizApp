...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun setQuestion(mCurrentPosition: Int) {

        var question = mQuestionList!![mCurrentPosition - 1]

        mTotalQuestion = mQuestionList!!.size
        progressBar.progress = mCurrentPosition
        tv_progress.text = "$mCurrentPosition" + "/" + "$mTotalQuestion"
                ...
                if (mSelectedAnswerPosition == 0) {
                    ...
                    when {
                        mCurrentPosition <= mQuestionList!!.size -> {
                            ...
                            intent.putExtra(Constants.TOTAL_QUESTIONS, mTotalQuestion)
                    ...
                    } else if (question!!.correctAnswer == mSelectedAnswerPosition) {
